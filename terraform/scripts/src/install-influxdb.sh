...
echo "######################################"
echo "# install-influxdb.sh"
echo "######################################" 

# influxdb.key GPG Fingerprint: 05CE15085FC09D18E99EFB22684A14CF2582E0C5
sudo wget -q https://repos.influxdata.com/influxdb.key
...
# setup influx
influx setup -u ${influxdb-user} -p ${influxdb-password} -t ${influxdb-token} -o ${influxdb-org} -b ${influxdb-bucket} -f
